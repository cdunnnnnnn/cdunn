...
function Header() {
  return (
    <header className="w-full h-screen bg-black">
      <a
        className="position absolute inset-1/2 block w-32 h-32 bg-black p-4 -mt-16 -ml-16"
        href="#"
      >
      ...
      <a
        className="absolute bottom-0 block w-full text-lg text-white text-center pb-12"
        href="#"
      >
        see my work
      </a>
